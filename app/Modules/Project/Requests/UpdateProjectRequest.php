...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'project_code' => 'nullable|string|max:100|unique:projects,project_code,'.($projectId ?? 'NULL'),
    ...
    public function messages(): array
    {
        return [
            ...
            'project_code.unique' => 'This project code is already assigned to another project.',
        ];
    }
}
