...
<head>
    ...
    <title>Registration Confirmed | 8<sup>th</sup> National Research Review</title>
    ...
    <main class="page-content">
        <div class="container">
            <div class="receipt-card">
                ...
                <p class="conf-desc">Thank you, <strong>{{ $registration->full_name }}</strong>. Your registration for the 8<sup>th</sup> National Research Review has been successfully received.</p>
                ...
                <div class="details-grid">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">8<sup>th</sup> National Research Review</span>
                    </div>
                    <div class="detail-row">
