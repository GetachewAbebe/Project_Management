            ...
            <div class="form-section">
                <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 3rem;">
                    <div class="form-group">
                        ...
                        <!-- Critical Issues -->
                        <div style="background: #fff5f5; border: 2px solid #feb2b2; border-radius: 12px; padding: 1.5rem; position: relative;">
                            <div style="position: absolute; top: -12px; left: 20px; background: #ef4444; color: white; padding: 2px 12px; border-radius: 4px; font-size: 0.7rem; font-weight: 950; letter-spacing: 0.05em; display: flex; align-items: center; gap: 0.4rem;">
                            ...
                            <label class="section-label" style="color: #c53030; margin-top: 0.5rem;">CRITICAL MANAGEMENT ISSUES</label>
                            <div class="input-wrapper">
                                <textarea name="critical_issues" rows="4" placeholder="Flag urgent recommendations or sensitive findings for top management (Optional)..." style="background: white; border-color: #fee2e2; padding-left: 1rem;"></textarea>
                            </div>
                        </div>
                    </div>
